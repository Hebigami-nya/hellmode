...
# Loot Table itself has a 33% chance of dropping the common drop and 5% of dropping the rare drop
...
scoreboard players add @s[scores={loot_balancing=..100}] loot_balancing 12