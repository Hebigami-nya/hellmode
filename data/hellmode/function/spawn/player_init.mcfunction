...
scoreboard players set @s generic_regeneration 0
scoreboard players set @s generic_resistance 0
scoreboard players set @s generic_slowness 0
scoreboard players set @s generic_speed 0
